...
const ProjectForm = ({
  ...
  const handleSubmit = async (e) => {
    ...
    const overallProgress = Math.round(
      (formData.appProgress +
        formData.panelProgress +
        formData.serverProgress) /
        3
    );
    const payload = {
      ...formData,
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                appProgress: parseInt(e.target.value) || 0,
              })
            }
            className="input-field"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                panelProgress: parseInt(e.target.value) || 0,
              })
            }
            className="input-field"
          />
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                serverProgress: parseInt(e.target.value) || 0,
              })
            }
            className="input-field"
          />
      ...
      <div className="mb-3 w-full">
        <label htmlFor="fileInput" className="dark:text-gray-300 mb-1">
          Select Files
        </label>
        <input
          id="fileInput"
  ...
  const handleViewClientMilestones = async (project) => {
    ...
    try {
      if (profileRole === "super-admin" || profileRole === "admin") {
        const { data } = await axios.get(
          `/api/projects/${project._id}/client-milestones`,
          {
            headers: { Authorization: `Bearer ${token}` },
          }
        );
    ...
    <div className="space-y-6">
        ...
        {projects?.map((project) => (
          ...
          >
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              ...
              <div className="text-center">
                <ProgressCircle
                  percentage={project.panelProgress}
                  size={50}
                  color="#10b981"
                />
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
              ...
              <div className="text-center">
                <ProgressCircle
                  percentage={project.serverProgress}
                  size={50}
                  color="#f59e0b"
                />
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
              ...
              <div className="text-center">
                <ProgressCircle
                  percentage={project.overallProgress}
                  size={50}
                  color="#8b5cf6"
                />
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
      ...
      >
        <ProjectForm
          ...
          selectedDataFromUser={
            selectedDataFromUser /* previously: selectedDataFromUser */
          }
        ...
        <div className="space-y-4">
          ...
          <div className="card hover:shadow-lg transition-shadow duration-200">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              />
              <StatusBadge
                status={selectedProject?.priority}
            ...
            <div className="grid grid-cols-4 gap-4 mb-4">
              <div className="text-center">
                <ProgressCircle
                  percentage={selectedProject?.appProgress}
                  size={50}
                />
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                  App
              ...
              <div className="text-center">
                <ProgressCircle
                  percentage={selectedProject?.panelProgress}
                  size={50}
                  color="#10b981"
                />
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
              ...
              <div className="text-center">
                <ProgressCircle
                  percentage={selectedProject?.serverProgress}
                  size={50}
                  color="#f59e0b"
                />
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
              ...
              <div className="text-center">
                <ProgressCircle
                  percentage={selectedProject?.overallProgress}
                  size={50}
                  color="#8b5cf6"
                />
                <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
          ...
          <div>
            ...
            {selectedProject?.milestones?.map((milestone) => (
              <div
                key={milestone._id}
                className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 my-2"
              >
                <div className="flex items-start justify-between mb-2">
