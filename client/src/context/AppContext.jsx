...
export const AppContextProvider = ({ children }) => {
    ...
    const fetchClientMilestones = async () => {
        ...
        try {
            ...
            const response = await axios.get('/api/client-milestones', {
                params: { type: 'client' }
            }, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const value = {
        ...
        projects, setProjects, fetchProjects, loadingProjects, setLoadingProjects,
        tasks, setTasks, fetchTasks,
        milestones, setMilestones, fetchMilestones, milestoneLoading, setMilestoneLoading,
        stats, setStats, fetchStats,
        fetchEntries, redZoneEntries, setRedZoneEntries, profileRole,
        fetchFeedbacks, feedbacks, setFeedbacks,
